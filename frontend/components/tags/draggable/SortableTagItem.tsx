...
const SortableTagItem: React.FC<SortableTagItemProps> = ({
    ...
    return (
        <div ref={setNodeRef} {...attributes} className={`inline-flex group relative ${isDragging ? 'z-10' : 'z-0'}`} data-tag-id={tag.id}>
            <div
            ...
            >
                ...
                >
                    <Button
                        ...
                        onPress={() => onRemove()}
                    >
                        <Icon icon="solar:close-circle-linear" width={8} height={8} />
                    </Button>
                </motion.div>
            </div>
        </div>
