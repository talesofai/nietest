...
import { getDefaultValueByType, RESERVED_VARIABLE_NAMES, isVariableNameLengthValid, TAG_TYPE_OPTIONS } from "@/components/tags/draggable/tagUtils";
...
const AddTagForm: React.FC<AddTagFormProps> = ({ onAdd, onCancel }) => {
    ...
    const handleSubmit = useCallback(() => {
        ...
        onAdd({
            ...
            ...((type === "character" || type === "element" || type === "prompt") && !isVariable && weight !== undefined ? { weight } : {})
        });
