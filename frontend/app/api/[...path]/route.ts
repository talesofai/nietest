...
async function proxyRequest(request: NextRequest, pathSegments: string[], method: string) {
    try {
        ...
        console.log(`[API代理] 发送${method}请求到: ${apiUrl}, 头信息:`, Object.fromEntries(headers.entries()));
        ...
        responseHeaders.set('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Token, X-Platform');
